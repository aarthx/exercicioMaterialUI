...
const ListarTarefa = () => {
  ...
  const [modalStatus, setModalStatus] = useState({active: false, severity: "success", message: "Tarefa criada com sucesso"});
  ...
  const handleDeletar = (id) => {
    ...
    setModalStatus({active: true, severity: "success", message: "Tarefa deletada com sucesso"})
  };
  ...
  const StyledTableRow = styled(TableRow)(({ theme }) => ({
    ...
    <div>
      ...
      >
        <div>
          <CriarTarefa handleClose={handleClose} tarefas={tarefas} setTarefas={setTarefas} modalStatusCriar={() => setModalStatus({active: true, severity: "success", message: "Tarefa criada com sucesso"})}/>
        </div>
      </Modal>  
    </div>
    <div>
      ...
      >
        <div>
          <EditarTarefa handleCloseEditar={handleCloseEditar} idTarefaSelecionada={idTarefaSelecionada} tarefas={tarefas} tarefa={tarefa} setTarefas={setTarefas} modalStatusEditar={() => setModalStatus({active: true, severity: "success", message: "Tarefa editada com sucesso"})}/>
        </div>
      </Modal>  
    </div>
    { modalStatus.active && 
      <Alert variant="filled" severity={modalStatus.severity} onClose={() => {setModalStatus(prevStats => {return {...prevStats, active: false}}) }}>
        {modalStatus.message}
      </Alert>
    }
